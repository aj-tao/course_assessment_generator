\begin{tcolorbox}[enhanced,attach boxed title to top center=
	...
	\begin{itemize}
		\item You will have \textbf{\printval{time}\ minutes} to complete the exam.
		\item There are \textbf{\printval{problemcount}\ problems}, some of which may have multiple parts. The entire exam is worth a total of \textbf{\printval{totalweight}\ points}; observe that the total number of points from all \printval{problemcount}\ problems exceeds the exam total, meaning that you can work on fewer problems and still attain the full exam score of \printval{totalweight} or more.
